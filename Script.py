...
Myself <a href=https://t.me/{}>{}</a>,\n\nTrust me ! I can't even imagine how super-fast i can drive your Database channel \n\nAre you ready for Long Drive Baby...🤪"""
    LZTHMB_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/+j2jWpVLFtFFlMzI1 >𝗠𝗼𝘃𝗶𝗲𝗦 & 𝗦𝗲𝗿𝗶𝗲𝗦 𝗛𝘂𝗕</a> work.\n\n<b>Thumbnail extracting</b> feature will be available soon, please join <a href=https://t.me/All_In_One_Prince_Bots>𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿</a> and stay tuned for next <a href=https://t.me/+j2jWpVLFtFFlMzI1>𝗠𝗼𝘃𝗶𝗲𝗦 & 𝗦𝗲𝗿𝗶𝗲𝗦 𝗛𝘂𝗕</a>.\n\n  🐞 Report Bug here: <a href=https://t.me/Prince_All_Supports>𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿𝘀 𝗦𝘂𝗽𝗽𝗼𝗿𝘁𝘀</a>
    """
    LZLINK_TEXT = """Hey {},
Glad to see you here. It seems that you really love <a href=https://t.me/+j2jWpVLFtFFlMzI1 >𝗠𝗼𝘃𝗶𝗲𝗦 & 𝗦𝗲𝗿𝗶𝗲𝗦 𝗛𝘂𝗕</a> work.\n\n<b>File to LiNK converting</b> feature will be available soon, please join <a href=https://t.me/All_In_One_Prince_Bots>𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿</a> and stay tuned for next <a href=https://t.me/+j2jWpVLFtFFlMzI1>𝗠𝗼𝘃𝗶𝗲𝗦 & 𝗦𝗲𝗿𝗶𝗲𝗦 𝗛𝘂𝗕</a>.\n\n  🐞 Report Bug here: <a href=https://t.me/Prince_All_Supports>𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿𝘀 𝗦𝘂𝗽𝗽𝗼𝗿𝘁𝘀</a>
    """
    DNT_TEXT = """Hey sweetie {},
Thanks for thinking about us.\nIt seems that you really love <a href=https://t.me/All_In_One_Prince_Bots >𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿</a> work.\n\n<b>For your kind information, we do not ask or force anyone for any kind of payment</b>. But if you really want to donate us then you can send money to us from below links...\n\n💵 Reach Donation Page : <a href=https://t.me/All_In_One_Prince_Bots/535>Click here...</a>\n\nT❤️ hank you so much..
    """
    REQ_AUTH_TEXT = """Hello {},
\nSorry sweetie.. You must have to be the Authentic User to complete this operation...\n\n👮‍♀ REPORT ISSUE HERE: <a href=https://t.me/Prince_All_Supports>Developer Support</a>\n\n
    """
...
"""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/All_In_One_Prince_Bots>𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
...
- Source - https://t.me/All_In_One_Prince_Bots  
- Please give a messege To To Get You your own bot. Salute to <a href=https://t.me/Help_Chat_u_bot>𝗦𝘂𝗽𝗽𝗼𝗿𝘁𝘀</a> for adding extra features in me.

<b>DEV:</b>
- 🦋 <a href=https://t.me/All_In_One_Prince_Bots>𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿</a> 🦋"""
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/All_In_One_Prince_Bots)</code>
