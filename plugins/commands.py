...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            InlineKeyboardButton('⪦ Learn BOT Making ⪧', url='https://t.me/All_In_One_Prince_Bots')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔔 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿𝘀 𝗦𝘂𝗽𝗽𝗼𝗿𝘁𝘀 🤖', url='https://t.me/Prince_All_Supports')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿 🦋", url='https://t.me/All_In_One_Prince_Bots'
                )
            ]
        ]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('🧞‍♀️ Search 🧐', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🔔 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿 🤖', url='https://t.me/+0dEbDXEbhHg3YjE1')
            ],[
            InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
        ...
        [
            InlineKeyboardButton('⪦ Learn BOT Making ⪧', url='https://t.me/Prince_All_Supports')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
            photo=random.choice(PICS),
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You 𝙋𝙍𝙄𝙉𝘾𝙀 𝘽𝘼𝘾𝙆𝙐𝙋 𝙒𝙊𝙍𝙇𝘿 ♥️')
